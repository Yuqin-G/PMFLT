...
from federated.client_fedmvp import Client_FedMVP
from model.FedMVP import FedMVP
from federated.utils import *
from model.FedMVP import load_clip_to_cpu

class Server_FedMVP(ServerBase):
    def create_client_instance(self, cfg, client_id, dataname, available_cls, available_data, dataset_info):
        return Client_FedMVP(cfg, client_id, dataname, available_cls, available_data=available_data, dataset_info=dataset_info)
    ...
    def build_model(self):
        ...
        self.model = FedMVP(cfg, self.global_classnames, clip_model, device=self.device)
