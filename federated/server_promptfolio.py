...
from model.PromptFolio import PromptFolio, load_clip_to_cpu
from federated.utils import *

class Server_PromptFolio(ServerBase):
    """PromptFolio联邦学习服务器"""

    def create_client_instance(self, cfg, client_id, dataname, available_cls, available_data, dataset_info):
        return Client_PromptFolio(cfg, client_id, dataname, available_cls, available_data=available_data, dataset_info=dataset_info)
    ...
    def build_model(self):
        ...
        self.model = PromptFolio(cfg, global_classnames, clip_model, device=self.device)
        self.w = cfg.MODEL.W
    ...
    def train(self):
        ...
        for round in range(self.start_round, self.comm_round):
            ...
            for idx in idxs_users:
                ...
                w_local1 = copy.deepcopy(w_local['prompt_learner.ctx'][1:])
        ...
        # For General FL, after completing training on all clients,
        # perform additional local training to obtain personalized models.
