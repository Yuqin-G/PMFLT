...
from model.PromptFolio import PromptFolio
from federated.utils import *
import torch.nn.functional as F
from federated.client_base import ClientBase

class Client_PromptFolio(ClientBase):
    ...
    def download(self, global_model):
        ...
        updated = torch.cat([global_model, self.model.prompt_learner.ctx[1:].to(self.device)], dim=0)
        self.model.prompt_learner.ctx.data.copy_(updated.data)
