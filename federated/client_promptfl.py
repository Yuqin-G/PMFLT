...
from model.PromptFL import PromptFL
from federated.utils import *
import torch.nn.functional as F
from federated.client_base import ClientBase

class Client_PromptFL(ClientBase):
    ...
    def download(self, global_model):
        ...
        self.model.prompt_learner.ctx.data.copy_(global_model.data)
    ...
    def train(self, num_round):
        ...
        # log_summary = {
        #     f"train/client{self.client_id}/loss": loss.item(),
        #     f"train/client{self.client_id}/acc": acc,
        # }

        # self.log_scalar(log_summary, num_round + 1)
