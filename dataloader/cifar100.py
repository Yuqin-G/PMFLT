...
class CIFAR100:
    def __init__(self, cfg, available_classes=None, global_classes=None, relabel=True):
        ...
        train_dataset = PyTorchCIFAR100(root=location+"/cifar100", train=True, download=False)
        test_dataset = PyTorchCIFAR100(root=location+"/cifar100", train=False, download=False)
