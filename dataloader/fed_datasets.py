...
class EuroSAT(DatasetBase):
    ...
    def __init__(self, cfg, available_classes=None, global_classes=None, relabel=True):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "EuroSAT","2750")
...
class FGVCAircraft(DatasetBase):
    ...
    dataset_dir = "fgvc_aircraft/fgvc-aircraft-2013b/data"
...
class UCF101(DatasetBase):
    ...
    def __init__(self, cfg, available_classes=None, global_classes=None, relabel=True):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "UCF-101-midframes", "UCF-101-midframes")
